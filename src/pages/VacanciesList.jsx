...
const SPHERES = [
  'IT, системная интеграция, интернет','Банки, инвестиции, лизинг','Бухгалтерия, управленческий учёт, финансы предприятия',
  'Государственные организации','Добыча сырья','Дом и быт','Издательство, полиграфия','Информационные технологии',
  'Искусство, культура','Консалтинг, управление проектами','Лёгкая промышленность','Лесная промышленность, деревообработка',
  'Маркетинг, реклама, BTL, PR, дизайн','Медицина, фармацевтика, аптеки','Металлургия, металлообработка',
  'Нефть и газ, энергетика','Образование, наука','Общественное питание','Охрана, безопасность, полиция',
  'Пищевая промышленность','Производство','Розничная торговля','СМИ, телевидение','Сельское хозяйство',
  'Спорт, фитнес, красота','Страхование','Строительство, недвижимость','Телекоммуникации, связь',
  'Транспорт, логистика','Туризм, гостиницы','Финансы','Химическое производство','Электроника, приборостроение','Юриспруденция',
];
